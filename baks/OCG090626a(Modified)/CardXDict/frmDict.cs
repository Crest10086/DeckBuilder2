    ...
    public partial class frmDict : Office2007Form, IXDictGrabSink  
    {
        ...
        public void ShowSearchList(CardDescription[] cards)
        {
            ...
            for (int i = 0; i < cards.Length; i++)
            {
                ...
                richTextBox1.AppendText(card.name);
                richTextBox1.Select(richTextBox1.Text.Length - card.name.Length, card.name.Length);
                ...
                richTextBox1.AppendText(card.japName);
                richTextBox1.AppendText("， 英文名：");
                richTextBox1.AppendText(card.enName);
                richTextBox1.AppendText("\n\r");
        ...
        public void ShowCardInfo(CardDescription card)
        {
            ...
            Tools.API.SendMessage(richTextBox1.Handle, Tools.APIConst.WM_VSCROLL, Tools.APIConst.SB_TOP, IntPtr.Zero);
        }
        ...
        private void buttonX1_Click(object sender, EventArgs e)
        {
            ...
            Cards = searcher.AllSearch(textBoxDropDown1.Text, 0);
        ...
        {
            listView2.Visible = listView1.Visible;
        }
